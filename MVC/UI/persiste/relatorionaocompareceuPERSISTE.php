...
<?php
    ...
    if($abll->ResultadoProcurarHistoricoNaoCompareceu($letra)){
        if(false)
            echo '<script> alert ("Falha ao procurar!"); </script>';
        else
            $result=$abll->ResultadoProcurarHistoricoNaoCompareceu($letra);
      }
?>
    <html lang="pt-br">
    ...
    <head>
        ...
        <title> Relatório Não Comparecido - Clientes </title>
    ...
    <body style="background-image: url('../imagens/fundo1.png'); background-repeat: no-repeat; background-size: cover">
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar navbar-dark bg-dark mb-3">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="../paginas/relatorionaocompareceu.php"> Relatório Cliente Não Comparecido <span class="sr-only">(current)</span></a>
                    </li>
                </ul>
        ...
        <div class="container text-center">
            ...
            <h1 class="text-center title"> Relatório Não Comparecido - Clientes </h1>

            <br>

            <div class="row justify-content-center">
                <div class="col-12 col-md-2">
                    <button type="button" class="btn btn-primary col-md-12 col-sm-12" onclick="location. href='../paginas/relatorionaocompareceu.php'"> Voltar
                    </button>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-4">
                    <a href="../pdf/gerarpdf_rel_naocompareceu_pesq.php?letra=<?php echo $letra; ?>"> <button type="button" class="btn btn-primary col-md-12 col-sm-12"> Gerar PDF desse Relatório </button> </a>
                    <br>
                    <br>
                </div>
            </div>
