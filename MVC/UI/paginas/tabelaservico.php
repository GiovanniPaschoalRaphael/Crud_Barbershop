...
?>
    ...
    <body style="background-image: url('../imagens/fundo1.png'); background-repeat: no-repeat; background-size: cover">
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar navbar-dark bg-dark mb-3">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="AreaDeServicos.php"> Cadastrar Serviços <span class="sr-only">(current)</span></a>
                    </li>
        ...
        <div class="container text-center">
            ...
            <br>
            <div>
                <img class="img-fluid" src="../imagens/tabelaservico.png" alt="logo barbeiro" width="205">
            </div>

            <h1 class="text-center title"> Serviços Cadastrados </h1>

            <form action="../persiste/tabelaservicoPERSISTE.php" method="post">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-6">
                        <div class="input-group mb-3">
                            <input class="form-control " type="text" name="letra" id="letra_ajuda" required placeholder="Ex: Cabelo + Barba" autofocus>
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <?php while($row = $result->fetch()){?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="Atualizarservico.php?id_servico=<?php echo $row["id_servico"]; ?>"> <img src="../imagens/atualizar.png" style="height: 40px; width: 40px"> </a>
                                            </td>
                                        </tr>
