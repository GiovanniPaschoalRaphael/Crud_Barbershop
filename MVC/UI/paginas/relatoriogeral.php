...
<?php
    ...
    $row_pg = $abll->ContarListarHistoricoGeral();
...
?>
    ...
    <body style="background-image: url('../imagens/fundo1.png'); background-repeat: no-repeat; background-size: cover">
        ...
        <div class="container text-center">
            ...
            <h1 class="text-center title">  Relatório Geral </h1>

            <div class="row mx-auto justify-content-center">
                <button type="button" class="btn btn-primary col-md-4 col-sm-12  " onclick="location. href='relatorionaocompareceu.php'"> Relatório Cliente Não Comparecido
                </button>
            </div>
            ...
            <form action="../persiste/relatoriogeralPERSISTE.php" method="post">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-4">
                    <button type="button" class="btn btn-primary col-md-12 col-sm-12" onclick="location. href='../pdf/gerarpdf_rel_geral.php'">Gerar PDF desse Relatório </button>
                    <br>
                    <br>
                </div>
            </div>
            ...
            <ul class="pagination justify-content-center">
                    <?php if($pagina==1){ ?>
                            <li class="page-item disabled"><a class="page-link" href="relatoriogeral.php?pagina=1" tabindex="-1">Primeira</a></li>
                    <?php } else{ ?>
                            <li class="page-item"><a class="page-link" href="relatoriogeral.php?pagina=1" tabindex="-1">Primeira</a></li>
                    <?php } ?>
                    <?php
                        for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
                        if($pag_ant >= 1){ ?>
                            <li class="page-item"><a class="page-link" href="relatoriogeral.php?pagina=<?php echo $pag_ant ?>"><?php echo $pag_ant ?></a></li>
                    <?php }} ?>
                    <li class="page-item disabled"><a class="page-link" href="#"><?php echo $pagina ?></a></li>
                    <?php
                        for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
                        if($pag_dep <= $quantidade_pg){ ?>
                            <li class="page-item"><a class="page-link" href="relatoriogeral.php?pagina=<?php echo $pag_dep ?>"><?php echo $pag_dep ?></a></li>
                    <?php }} ?>
                    <?php if($quantidade_pg==0 || $pagina==$quantidade_pg){ ?>
                            <li class="page-item disabled"><a class="page-link" href="relatoriogeral.php?pagina=<?php echo $quantidade_pg ?>">Última</a></li>
                    <?php } else{ ?>
                            <li class="page-item"><a class="page-link" href="relatoriogeral.php?pagina=<?php echo $quantidade_pg ?>">Última</a></li>
                    <?php } ?>
            </ul>
        ...
        <script>
            $(function() {
                $("#letra_ajuda").autocomplete({
                    source: 'proc_nome_cli_rel_geral.php'
                });
            });
        </script>
