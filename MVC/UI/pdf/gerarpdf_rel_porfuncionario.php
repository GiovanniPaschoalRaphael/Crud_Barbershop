<?php
    ...
    $fbll=new agendamentoBLL();
    $inicio = null;
    $qnt_result_pg = null;
    $result = $fbll->ListarHistoricoPorFuncionario($inicio, $qnt_result_pg);
	...
	$dompdf->load_html('
		<h1 style="text-align:center; color:#0174DF"> Relatório por Funcionário </h1>
		'. $html . '
	');
